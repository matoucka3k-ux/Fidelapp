  ...
  return (
    <div className={styles.page}>
      <nav className={styles.nav}>
        ...
        <button className={styles.navLink} onClick={() => navigate('/')}>Déjà un compte ? Se connecter</button>
      </nav>
      ...
      <div className={styles.center}>
        <div className={styles.card}>
          ...
          <button className={styles.btnBlue} onClick={() => navigate('/bienvenue')}>
            Créer mon compte →
          </button>

          <p className={styles.note}>
            En créant un compte, vous acceptez nos <span className={styles.link}>CGU</span> et notre <span className={styles.link}>politique de confidentialité</span>.
          </p>

          <div className={styles.divider}>
            <span className={styles.divLine} />
            <span className={styles.divText}>déjà inscrit ?</span>
            <span className={styles.divLine} />
          </div>

          <button className={styles.btnOutline} onClick={() => navigate('/')}>Se connecter</button>
        </div>
      </div>
    </div>
  )
